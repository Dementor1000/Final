...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton("⚡ UᎮDΛTΞS ⚡", url="https://t.me/JohnnyMoviess")
            ],[
            InlineKeyboardButton("🔞 ΛDULϮ BԾϮ 🔞", url="https://t.me/johnnyerotica")
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("🧩 TUϮԾᏒIΛL", url="https://t.me/JohnnyRequestBotTutorial"),
            InlineKeyboardButton("🍿 UᎮDΛTΞS 🍿", url="https://t.me/JohnnyMoviess")
            ],[
